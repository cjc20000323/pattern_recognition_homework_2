...
class GradualWarmupScheduler(_LRScheduler):
    ...
    Args:
        ...
        multiplier: start learning rate = base lr * multiplier
    ...
    def __init__(self, optimizer, multiplier, warmup_epochs, after_scheduler=None):
        ...
        if self.multiplier > 1.:
            raise ValueError('multiplier should be smaller or equal to 1.')
    ...
    def get_lr(self):
        ...
        return [base_lr * ((1.0 - self.multiplier) * self.last_epoch / (self.warmup_epochs - 1) \
    ...
    def load_state_dict(self, state_dict):
        ...
        self.after_scheduler.optimizer = self.optimizer