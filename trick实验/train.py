...
from losses import CenterLoss, TripletLoss, CrossEntropyLabelSmooth
...
if __name__ == '__main__':
    ...
    scheduler = WarmupMultiStepLR(optimizer=optimizer, milestones=[40, 70], warmup_epochs=5)
    ...
    for epoch in range(1, epochs + 1):
        ...
        scheduler.step()
        print(f'Epoch: {epoch}, Lr: {epoch_lr}, Train Loss: {train_loss}, Train Acc: {train_acc:.2%}')
